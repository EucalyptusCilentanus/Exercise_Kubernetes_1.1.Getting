...
async function downloadImageTo(imageFilePath) {
  const res = await fetch(IMAGE_URL, {
    redirect: "follow",
    headers: { "User-Agent": "dwk-image-cache/1.12" }
  });
...
/*
  Semantica richiesta dall'esercizio:
  - finché non scade: stessa immagine
  - scaduta: la prima richiesta dopo la scadenza serve ancora la vecchia (senza download)
  - dalla richiesta successiva: nuova immagine (download)
*/
